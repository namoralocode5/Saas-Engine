...
with st.expander("⚙️ Portfolio, Volume & Exchange Settings", expanded=False):
  ...
  st.session_state.leverage = st.slider(
      "Leverage", min_value=1, max_value=5, value=st.session_state.leverage
  )
  ...
  st.session_state.fee_pct = st.number_input(
...
if "scan_results" in st.session_state and st.session_state.scan_results:
  ...
  st.caption(
      f"⏱️ Last Update: **{now_str}** | Min. Vol:"
      f" **${st.session_state.min_vol:,.0f}**"
  )
